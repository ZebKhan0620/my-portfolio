      ...
      return (
        <div className="bg-gray-950 rounded-lg border border-green-500/30 p-3 xs:p-4 font-mono shadow-lg overflow-hidden h-full flex flex-col">
          <div className="flex items-center mb-2 xs:mb-3">
            ...
            <p className="text-white/40 text-xs">user@portfolio ~ $</p>
          </div>
          <p className="text-green-500 mb-1 xs:mb-2 text-xs xs:text-sm">
            <span className="text-blue-400">cat</span> advice_from_{entry.name.toLowerCase().replace(/\s+/g, '_')}.txt
          </p>
          <div className="flex-grow overflow-y-auto">
      ...
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 md:px-8 max-w-7xl">
        ...
        {advice.length > 0 ? (
          ...
          <div className="text-center py-8 xs:py-10">
            <div className="inline-block animate-spin rounded-full h-6 w-6 xs:h-8 xs:w-8 border-t-2 border-emerald-500 border-r-2 border-emerald-500 border-b-2 border-transparent"></div>
            <p className="mt-2 text-white/60 text-sm xs:text-base">Loading advice...</p>
          </div>
        ) : (
          <div className="text-center py-8 xs:py-10">
            <p className="text-white/60 text-sm xs:text-base">Be the first to leave advice!</p>
          </div>
        )}
      </div>
