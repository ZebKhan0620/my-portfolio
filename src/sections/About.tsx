        ...
        <div className="mt-6 sm:mt-8 grid grid-cols-1 md:grid-cols-6 gap-3 xs:gap-4">
              ...
              <div className="flex items-start gap-2 xs:gap-3 group">
                ...
                <div>
                  <p className={`font-medium text-white ${
                    ...
                    {t('about.journey.roles.frontend.title')}
                  </p>
                  <p className={`text-sm text-white/70 ${
                    language === 'ja' ? 'font-[var(--font-jp)]' : 'font-[var(--font-sans)]'
                  }`}>
                    {t('about.journey.roles.frontend.description')}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2 xs:gap-3 group">
                ...
                <div>
                  <p className={`font-medium text-white ${
                    ...
                    {t('about.journey.roles.halTokyo.title')}
                  </p>
                  <p className={`text-sm text-white/70 ${
                    language === 'ja' ? 'font-[var(--font-jp)]' : 'font-[var(--font-sans)]'
                  }`}>
                    {t('about.journey.roles.halTokyo.description')}
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2 xs:gap-3 group">
                ...
                <div>
                  <p className={`font-medium text-white ${
                    ...
                    {t('about.journey.roles.technical.title')}
                  </p>
                  <p className={`text-sm text-white/70 ${
                    language === 'ja' ? 'font-[var(--font-jp)]' : 'font-[var(--font-sans)]'
                  }`}>
                    {t('about.journey.roles.technical.description')}
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card className="md:col-span-2 p-0 overflow-hidden relative min-h-[200px] xs:min-h-[220px] sm:min-h-[240px]">
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-black/70 backdrop-blur-sm rounded-lg p-2 text-center">
              <p className="text-white text-sm xs:text-base font-medium">{t('about.location.title')}</p>
            </div>
          </Card>
          ...
          <Card className="md:col-span-6 overflow-hidden bg-gradient-to-br from-gray-800/50 to-gray-900/30">
            <div className="p-4 sm:p-5">
              <h3 className={`text-lg xs:text-xl font-semibold text-white mb-1 sm:mb-2 ${
                language === 'ja' ? 'font-[var(--font-jp)]' : 'font-[var(--font-serif)]'
              }`}>
          ...
          <Card className="md:col-span-6 min-h-[240px] xs:min-h-[260px] sm:min-h-[280px] p-0 bg-gradient-to-br from-gray-800/50 to-gray-900/30">
            ...
            >
              {Hobbies.map((hobby, index) => {
                ...
                const hobbyKey = hobby.name.toLowerCase();
                const translatedHobbyName = t(`about.hobbies.items.${hobbyKey}`);
                ...
                return (
                  <motion.div 
                    ...
                    tabIndex={0}
                    role="button"
                    aria-label={`${translatedHobbyName} hobby bubble, draggable`}
                  >
                    <span className="mr-1 xs:mr-1.5">{hobby.iconType}</span>
                    <span className="text-gray-900 font-medium">{translatedHobbyName}</span>
                  </motion.div>
                );
              })}
            </div>
          ...
          <Card className="md:col-span-4 p-4 xs:p-5 sm:p-6 bg-gradient-to-br from-gray-800/50 to-gray-900/30">
            <h3 className={`text-lg xs:text-xl font-semibold text-sky-400 mb-4 sm:mb-6 ${
              language === 'ja' ? 'font-[var(--font-jp)]' : 'font-[var(--font-serif)]'
            }`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div>
                <div className="flex items-center gap-2 mb-3 sm:mb-4">
                  ...
                  <h4 className={`font-medium text-white ${
                    ...
                    {t('about.career.shortTerm.title')}
                  </h4>
                </div>
                  ...
                  <li className="flex items-start gap-2 xs:gap-3">
                    ...
                    <div>
                      <span className={`text-white/90 block ${
                        ...
                        {t('about.career.shortTerm.goals.0.text')}
                      </span>
                      <span className="text-white/50 text-sm">{t('about.career.shortTerm.goals.0.status')}</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-2 xs:gap-3">
                    <div className="bg-sky-400 p-1.5 rounded-full flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <span className={`text-white/90 block ${
                        ...
                        {t('about.career.shortTerm.goals.1.text')}
                      </span>
                      <span className="text-white/50 text-sm">{t('about.career.shortTerm.goals.1.status')}</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-2 xs:gap-3">
                    <div className="bg-sky-400 p-1.5 rounded-full flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <span className={`text-white/90 block ${
                        ...
                        {t('about.career.shortTerm.goals.2.text')}
                      </span>
                      <span className="text-white/50 text-sm">{t('about.career.shortTerm.goals.2.status')}</span>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-3 sm:mb-4">
                  ...
                  <h4 className="font-medium text-white">{t('about.career.longTerm.title')}</h4>
                </div>
                <ul className="space-y-3 sm:space-y-4">
                  <li className="flex items-start gap-2 xs:gap-3">
                    ...
                    <div>
                      <span className="text-white/90 block">{t('about.career.longTerm.goals.0.text')}</span>
                      <span className="text-white/50 text-sm">{t('about.career.longTerm.goals.0.status')}</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-2 xs:gap-3">
                    <div className="bg-emerald-400 p-1.5 rounded-full flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <span className="text-white/90 block">{t('about.career.longTerm.goals.1.text')}</span>
                      <span className="text-white/50 text-sm">{t('about.career.longTerm.goals.1.status')}</span>
                    </div>
                  </li>
                  <li className="flex items-start gap-2 xs:gap-3">
                    <div className="bg-emerald-400 p-1.5 rounded-full flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <span className="text-white/90 block">{t('about.career.longTerm.goals.2.text')}</span>
                      <span className="text-white/50 text-sm">{t('about.career.longTerm.goals.2.status')}</span>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="group bg-gradient-to-r from-emerald-500/10 to-sky-500/10 p-3 xs:p-4 rounded-xl">
                <div className="flex items-start gap-2 xs:gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-base xs:text-lg text-white">{t('about.achievements.ielts.title')}</h4>
                    <div className="mt-1">
                      <span className="px-2 py-0.5 bg-emerald-500/20 text-emerald-300 rounded-full text-xs xs:text-sm">{t('about.achievements.ielts.score')}</span>
                    </div>
                    <p className="text-white/70 mt-1 xs:mt-2 text-xs xs:text-sm">{t('about.achievements.ielts.description')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group bg-gradient-to-r from-amber-500/10 to-orange-500/10 p-3 xs:p-4 rounded-xl">
                <div className="flex items-start gap-2 xs:gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-base xs:text-lg text-white">{t('about.achievements.halAward.title')}</h4>
                    <div className="mt-1 flex flex-wrap items-center gap-1.5 xs:gap-2">
                      <span className="px-2 py-0.5 bg-amber-500/20 text-amber-300 rounded-full text-xs xs:text-sm">{t('about.achievements.halAward.badge')}</span>
                      <button 
                      ...
                      >
                        <span>{t('about.achievements.halAward.viewCertificate')}</span>
                    ...
                    <p className="text-white/60 text-xs xs:text-sm mt-1 xs:mt-2">
                      {t('about.achievements.halAward.description')}
                    </p>
                  </div>
                </div>
              </div>
