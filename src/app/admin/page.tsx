                  ...
                  <div className="p-6">
                    <div className="flex items-start mb-4">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-400 text-sm mt-1">i18n & debugging utilities</p>
                      </div>
                    </div>
                    <p className="text-gray-300 mb-6">Access translation debugging tools and internationalization helpers to assist with development and content management.</p>
                    <Link 
                      href="/admin/tools" 
